...
},{"_process":5,"timers":6}],3:[function(require,module,exports){
'use strict';
...
},{"./mixins/index.es6.js":11,"./model.es6.js":12,"./page.es6.js":14,"./view.es6.js":17,"jquery":4}],10:[function(require,module,exports){
"use strict";
...
},{"./events.es6.js":10}],12:[function(require,module,exports){
"use strict";
...
var browserUIWrapper = require('./ui-wrapper.es6.js');
...
BaseModel.prototype = $.extend({}, mixins.events, {
   ...
   **/
  sendMessage: function sendMessage(messageType, options) {
    return browserUIWrapper.sendMessage(messageType, options);
  },
  submitBrokenSiteReport: function submitBrokenSiteReport(brokenSiteData) {
...
},{"./mixins/index.es6.js":11,"./store.es6.js":15,"./ui-wrapper.es6.js":16,"jquery":4}],13:[function(require,module,exports){
"use strict";
...
},{"./mixins/index.es6.js":11,"./store.es6.js":15}],15:[function(require,module,exports){
"use strict";
...
function _publish(notification) {
  if (notification && notification.change) {
    console.info("STORE NOTIFICATION change:".concat(notification.notifierName), notification);

    _publisher.emit("change:".concat(notification.notifierName), notification);
  }

  if (notification && notification.action) {
    console.info("STORE NOTIFICATION action:".concat(notification.notifierName), notification);
...
},{"./notifiers.es6.js":13,"deep-freeze":1,"eventemitter2":2,"is-plain-object":3}],16:[function(require,module,exports){
"use strict";
...
},{"../../shared-utils/parse-user-agent-string.es6":8,"webextension-polyfill":7}],17:[function(require,module,exports){
"use strict";
...
},{"./mixins/index.es6.js":11,"./store.es6.js":15,"jquery":4}]},{},[9]);
